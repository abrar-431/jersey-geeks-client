...
const Register = () => {
    ...
    return (
        <div className='flex flex-col md:flex-row gap-6 my-6'>
            <Helmet>
                <title>Jersey Geeks | Register</title>
            </Helmet>
            ...
            <div className='md:w-1/2 w-full '>
                <Slide damping={0.8} direction="right">
                    <div className='shadow-xl bg-gray-100 flex flex-col'>
                        ...
                        <h2 className="text-2xl font-bold text-center">Welcome to, Jersey Geeks</h2>
                        ...
                        <form onSubmit={handleRegister} className="card-body">
                            <div className="form-control">
                                ...
                                <div className=' relative'>
                                    <input type="text" placeholder="Name" name='name' className={theme === 'dark' ?
                            ...
                            <div className="form-control">
                                ...
                                <div className=' relative'>
                                    <input type="text" placeholder="Email" name='email' className={theme === 'dark' ?
                                        "input input-bordered w-full pl-12 bg-gray-50"
                                        :
                                        "input input-bordered w-full pl-12"
                                    } required />
                            ...
                            <div className="form-control">
                                ...
                                <div className=' relative'>
                                    <input type="text" placeholder="Photo URL" name='photo' className={theme === 'dark' ?
                                        "input input-bordered w-full pl-12 bg-gray-50"
                                        :
                                        "input input-bordered w-full pl-12"
                                    } required />
                            ...
                            <div className="form-control mt-6 w-1/2 mx-auto">
                                <button className='rounded-lg btn bg-green-800 text-white'>Register</button>
                            </div>
                            <p className='mt-2 text-green-800 text-center'>Already have an account?
                                <Link to='/login' className="link link-hover text-green-900">  Login <LuMousePointerClick className='text-xl inline-flex' /></Link>
                            </p>
                        </form>
